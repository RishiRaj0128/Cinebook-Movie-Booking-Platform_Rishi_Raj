...
const DEFAULT_THEATERS: Theater[] = [
  ...
  {
    id: 'th-delhi',
    name: 'Cinepolis VIP Saket',
    city: 'Delhi',
    address: 'DLF Avenue Mall, Saket, New Delhi',
  },
  {
    id: 'th-bengaluru',
    name: 'INOX Megaplex Mantri',
    city: 'Bengaluru',
    address: 'Mantri Square Mall, Malleshwaram, Bengaluru',
  },
  {
    id: 'th-hyderabad',
    name: 'Prasads IMAX Multiplex',
    city: 'Hyderabad',
    address: 'NTR Gardens, Khairatabad, Hyderabad',
  },
  {
    id: 'th-chennai',
    name: 'SPI Palazzo Multiplex',
    city: 'Chennai',
    address: 'Nexus Vijaya Mall, Vadapalani, Chennai',
  },
  {
    id: 'th-kolkata',
    name: 'PVR Mani Square Superplex',
    city: 'Kolkata',
  ...
  },
  {
    ...
    city: 'Ahmedabad',
    address: 'Thaltej Cross Road, Ahmedabad',
  },
  {
    id: 'th-jaipur',
  ...
  {
    id: 'th-lucknow',
    name: 'Wave Cinemas Gomti Nagar',
    city: 'Lucknow',
    address: 'Vibhuti Khand, Gomti Nagar, Lucknow',
  },
  {
    id: 'th-kochi',
    name: 'PVR Lulu International Mall',
    city: 'Kochi',
  ...
  },
  {
    ...
    name: 'INOX C21 Mall',
    city: 'Indore',
    address: 'AB Road, Scheme 54, Indore',
  },
  {
    id: 'th-vizag',
    name: 'Cinepolis Jagadamba Junction',
    city: 'Visakhapatnam',
    address: 'Chitralaya Mall, Visakhapatnam',
  },
  {
    id: 'th-surat',
    name: 'Rajhans Cinema Multiplex',
    city: 'Surat',
    address: 'Pal Hazira Road, Adajan, Surat',
  },
  {
    id: 'th-patna',
    name: 'Cinepolis Patna Central Mall',
    city: 'Patna',
  ...
  },
  {
    ...
    city: 'Bhubaneswar',
    address: 'Rudrapur, NH 16, Bhubaneswar',
  },
  {
    id: 'th-guwahati',
    name: 'PVR City Centre',
    city: 'Guwahati',
...
export const ShowtimeModal: React.FC<ShowtimeModalProps> = ({
  ...
  const generateDynamicShows = (
    ...
    const sourceTheaters =
      theaterList.length > 0 ? theaterList : DEFAULT_THEATERS;
      ...
      .then((theaters) => {
        if (theaters && theaters.length > 0) {
          ...
          const cityNames = Array.from(
            new Set(theaters.map((t) => t.city).filter(Boolean))
          );
  ...
  const activeDateObj =
    dates.find((d) => d.dateStr === selectedDate) || dates[0];
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        ...
        style={{ maxWidth: 800, padding: '2rem' }}
      ...
      >
            ...
            {dates.map((d) => (
              ...
              >
                <div
                  style={{
                    fontSize: '0.7rem',
                    color: selectedDate === d.dateStr ? '#e50914' : '#9ca3af',
                    textTransform: 'uppercase',
                    fontWeight: 700,
                  }}
                >
                ...
                <div
                  style={{
                    fontSize: '1.15rem',
                    fontWeight: 800,
                    color: selectedDate === d.dateStr ? '#e50914' : '#f3f4f6',
                  }}
                >
                  {d.dayNum}
                </div>
        ...
        {loading ? (
          ...
          >
            Loading theater showtimes & locations...
          </div>
        ) : theaterMap.size === 0 ? (
          <div
            style={{
          ...
          >
            No showtimes scheduled for {activeDateObj.fullFormatted} in{' '}
            {selectedCity === 'All' ? 'any city' : selectedCity}. Try selecting
            another date!
          </div>
        ) : (
          <div
          ...
          >
            {Array.from(theaterMap.values()).map(
              ({ theater, shows: theaterShows }) => (
                <div
                  key={theater?.id || Math.random()}
